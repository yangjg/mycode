...
#define  APP_CODE_SIGN_TYPE 1
#define  APP_KEY_SIGN_TYPE 2
#define  UPLOAD_SIGN_TYPE 3
#define  GAME_CODE_SIGN_TYPE 4
#define  GAME_KEY_SIGN_TYPE 5
#define  AES_PRIVATE_TYPE 6
#define  AES_IV_TYPE 7
