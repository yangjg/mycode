...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener{
    ...
    private void findViews() {
        ...
        View view = inflater.inflate(R.layout.expandable_inner_layout,this);
        mTv =  Views.findViewById(view,R.id.expandable_text);
        if(TextUtils.isEmpty(mExpandString)){
            mExpandString = getContext().getString(R.string.expand_text);
        }
        if(TextUtils.isEmpty(mCollapseString)){
            mCollapseString = getContext().getString(R.string.collapse_text);
        }
        mButton = Views.findViewById(view, R.id.expand_collapse);
        mButton.setText(mCollapsed ? mExpandString : mCollapseString);
