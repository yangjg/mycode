...
/**
 * Created by yangjingan on 17-12-5.
 */
...
class BottomHelper {
     ...
     */
    public static void bindTabWithData(BottomNavigationItem bottomNavigationItem, BottomNavigationTab bottomNavigationTab, MyBottomBar bottomNavigationBar) {
