...
public class MyBottomBar extends FrameLayout {
    ...
    /**
     * This method initiates the MyBottomBar properties,
     * Tries to get them form XML if not preset sets them to their default values.
     *
     * @param context context of the MyBottomBar
    ...
    /**
     * This method initiates the MyBottomBar and handles layout related values
     */
    private void init() {
...
//    }
     ...
     */
    public MyBottomBar addItem(BottomNavigationItem item) {
     ...
     * @return this, to allow builder pattern
     */
    public MyBottomBar removeItem(BottomNavigationItem item) {
     ...
     * @return this, to allow builder pattern
     */
    public MyBottomBar setMode(@Mode int mode) {
        this.mMode = mode;
        return this;
    }
     ...
     * @return this, to allow builder pattern
     */
    public MyBottomBar setBackgroundStyle(@BackgroundStyle int backgroundStyle) {
     ...
     * @return this, to allow builder pattern
     */
    public MyBottomBar setActiveColor(@ColorRes int activeColor) {
     ...
     * @return this, to allow builder pattern
     */
    public MyBottomBar setActiveColor(String activeColorCode) {
     ...
     * @return this, to allow builder pattern
     */
    public MyBottomBar setInActiveColor(@ColorRes int inActiveColor) {
     ...
     * @return this, to allow builder pattern
     */
    public MyBottomBar setInActiveColor(String inActiveColorCode) {
     ...
     * @return this, to allow builder pattern
     */
    public MyBottomBar setBarBackgroundColor(@ColorRes int backgroundColor) {
     ...
     * @return this, to allow builder pattern
     */
    public MyBottomBar setBarBackgroundColor(String backgroundColorCode) {
     ...
     * @return this, to allow builder pattern
     */
    public MyBottomBar setFirstSelectedPosition(int firstSelectedPosition) {
     ...
     */
    private MyBottomBar setScrollable(boolean scrollable) {
    ...
    public void initialise() {
        if (!mBottomNavigationItems.isEmpty()) {
            ...
            int lp  = mTabContainer.getPaddingLeft() ;
            int rp = mTabContainer.getPaddingRight() ;
            screenWidth = screenWidth - lp -rp ;
     ...
     * @return this, to allow builder pattern
     */
    public MyBottomBar setTabSelectedListener(OnTabSelectedListener tabSelectedListener) {
     ...
     * @return this, to allow builder pattern
     */
    public MyBottomBar setAnimationDuration(int animationDuration) {
    ...
    private void setUpTab(BottomNavigationTab bottomNavigationTab, BottomNavigationItem currentItem, int itemWidth, int itemActiveWidth) {
        ...
        BottomHelper.bindTabWithData(currentItem, bottomNavigationTab, this);
