...
public class AnimatorEvents extends Activity {
    ...
    private static final String TAG = "AnimatorEvents";
    ...
    public class XEvaluator implements TypeEvaluator {
        public Object evaluate(float fraction, Object startValue, Object endValue) {
            float startXY = (Float) startValue;
            float endXY = (Float) endValue;
            float res =startXY + fraction * (endXY - startXY);
           // Log.e(TAG,String.format("evaluate,fraction== %s,startX=%s,endX=%s,res=%s",fraction,startXY,endXY,res));
            return new Float(startXY + fraction * (endXY - startXY));
        }
    }
    ...
    public class YEvaluator implements TypeEvaluator {
        public Object evaluate(float fraction, Object startValue, Object endValue) {
            ...
            float endXY = (Float) endValue;
            float res =startXY + fraction * (endXY - startXY);
           // Log.e(TAG,String.format("evaluate,fraction== %s,startY=%s,endY=%s,res=%s",fraction,startXY,endXY,res));
            return new Float(startXY + fraction * (endXY - startXY));
        }
    }
    ...
    ValueAnimator.AnimatorUpdateListener {
        ...
        private void createAnimation() {
            Log.e(TAG, String.format("createAnimation "));
            if (animation == null) {
                Log.e(TAG, String.format("createAnimation first,startX==%s,startY==%s", ball.getX(), ball.getY()));
     /*           ObjectAnimator yAnim = ObjectAnimator.ofObject(ball, "y", new YEvaluator(),
                        ball.getY(), getHeight() - 50f).setDuration(1000);*/
             ...
             /*   ObjectAnimator xAnim = ObjectAnimator.ofObject(ball, "x", new XEvaluator(),
        ...
        protected void onDraw(Canvas canvas) {
           // Log.e(TAG,String.format("onDraw==x:%s,y=%s",ball.getX(), ball.getY()));
            canvas.save();
