...
public class CustomEvaluator extends Activity {
    ...
    private static final String TAG = "CustomEvaluator";
    ...
    public class XYEvaluator implements TypeEvaluator {
        public Object evaluate(float fraction, Object startValue, Object endValue) {
            ...
            Log.e(TAG,String.format("evaluate,fraction== %s",fraction));
    ...
    public class MyAnimationView extends View implements ValueAnimator.AnimatorUpdateListener,Animator.AnimatorListener {
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            Log.e(TAG,String.format("onAnimationUpdate"));
            invalidate();
        }

        @Override
        public void onAnimationStart(Animator animation) {
            Log.e(TAG,String.format("onAnimationStart"));
        }

        @Override
        public void onAnimationEnd(Animator animation) {
            Log.e(TAG,String.format("onAnimationEnd"));
        }

        @Override
        public void onAnimationCancel(Animator animation) {
            Log.e(TAG,String.format("onAnimationCancel"));
        }

        @Override
        public void onAnimationRepeat(Animator animation) {
            Log.e(TAG,String.format("onAnimationRepeat"));
        }
    }
}