...
public class BouncingBalls extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout container = new MyLinearLayout(this);
        ...
        setContentView(container,vparams);
      //  setContentView(R.layout.bouncing_balls);
    //    LinearLayout container = (LinearLayout) findViewById(R.id.container);
        MyAnimationView myAnimationView =  new MyAnimationView(this);
        ViewGroup.LayoutParams params = myAnimationView.getLayoutParams();
        container.addView(myAnimationView);
        params = myAnimationView.getLayoutParams();
    ...
    public static class MyLinearLayout extends LinearLayout{
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            int at =MeasureSpec.AT_MOST;
            int us =MeasureSpec.UNSPECIFIED;
            int count =getChildCount();
            LinearLayout.LayoutParams lastP;
    ...
    public class MyAnimationView extends View {
        ...
        public boolean onTouchEvent(MotionEvent event) {
            ...
            if(null != balls && balls.size()>=1)return false;
       ...
       /*     RadialGradient gradient = new RadialGradient(25f, 25f,
                    25f, color, darkColor, Shader.TileMode.CLAMP);*/
