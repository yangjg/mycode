            ...
            if (action == MotionEvent.ACTION_DOWN || action == MotionEvent.ACTION_MOVE
                ...
                for (int i = 0; i < N; i++) {
                    for (int j = 0; j < P; j++) {
                        ...
                        String msg = String.format("getHistoricalX=={%f},getHistoricalY=={%f}" +
                                        "getHistoricalPressure=={%f},getHistoricalTouchMajor=={%f}" +
                                        "getHistoricalTouchMinor=={%f},getHistoricalOrientation=={%f}"+
                                        "getHistoricalAxisValue=={%f},getHistoricalAxisValue=={%f}",
                                event.getHistoricalX(j, i), event.getHistoricalY(j, i),
                                event.getHistoricalPressure(j, i),
                                event.getHistoricalTouchMajor(j, i),
                                event.getHistoricalTouchMinor(j, i),
                                event.getHistoricalOrientation(j, i),
                ...
                mCurX = event.getX();
                mCurY = event.getY();
                String msg = String.format("getHistorySize=={%d},getPointerCount=={%d}",N,P);
                Log.e(TAG,msg);
            }
            return true;
        }
