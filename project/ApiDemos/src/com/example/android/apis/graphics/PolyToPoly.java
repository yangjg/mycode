...
public class PolyToPoly extends GraphicsActivity {
    ...
    private static final String TAG = "PolyToPoly";
    ...
    private static class SampleView extends View {
        ...
        private void doDraw(Canvas canvas, float src[], float dst[]) {
            canvas.save();
            mMatrix.reset();
            printLogMatrix(mMatrix, "reset");
            mMatrix.setPolyToPoly(src, 0, dst, 0, src.length >> 1);
            canvas.concat(mMatrix);
            printLogMatrix(mMatrix,"setPoly");
        ...
        private void printLogMatrix(Matrix matrix,String info){
            String msg = matrix.toString();
            Log.e(TAG,info + "  "+ msg);
        }
     ...
     /*       canvas.save();
            ...
            doDraw(canvas, new float[]{10,10,100,0}, new float[]{10, 10,100,100});

          //  doDraw(canvas,src,dst);
            canvas.restore();
        }
    }
}
